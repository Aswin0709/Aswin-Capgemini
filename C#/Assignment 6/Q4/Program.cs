...
namespace BankerIcici
{
    ...
    public class ICICIbank
    {
        ...
        public ICICIbank() { }
        public ICICIbank(int accountNumber, string customerName)
        {
    ...
    public class program
    {
        ...
        public static void Main()
        {
            ...
            bool dec = true;
            List<ICICIbank> accounts = new List<ICICIbank>();
            ...
            while (dec)
            {
                ...
                switch (decision)
                {
                    case 1:
                        ...
                        ICICIbank account = new ICICIbank(accountNumber, customerName);
