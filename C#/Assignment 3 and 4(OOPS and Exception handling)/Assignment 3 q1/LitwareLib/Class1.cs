...
namespace LitwareLib
{
    ...
    public class Manager : Employee
    {
        ...
        public override void CalculateSalary()
        {
            ...
            this.PF = .1 * this.GrossSalary;
            this.GrossSalary = this.GrossSalary + (this.PetrolAllowance + this.FoodAllowance + this.OtherAllowances);
            this.TDS = .18 * this.GrossSalary;
            this.NetSalary = this.GrossSalary - (this.PF + this.TDS);
    ...
    {
        public float KilometerTravel;
        public float TourAllowance;
        public int TelephoneAllowances = 1000;
